...
<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
 <tr>
  <td>
  <fieldset style="width:100%; border : 1px solid #73C8F9;text-align:left;COLOR:#023726;FONT-SIZE: 12px;"><legend align="left"><a href="#" onclick="displaypermission()">权限分配&nbsp;&nbsp;关闭</a></legend>
										...
										<s:if test="#request.popedomList!=null && #request.popedomList.size()>0">
												...
												<s:iterator value="#request.popedomList" var="popedom">
														...
														<s:if test="#request.flag=='2'">
														 ...
														 <td class="ta_01"  align="left" width="18%" height="22" background="../images/tablehead.jpg" >
															<s:if test="#popedom.flag==1">
																<input type="checkbox"  name="selectoper" id="<s:property value="#popedom.mid"/>_<s:property value="#popedom.mid"/>" value="<s:property value="#popedom.mid"/>_<s:property value="#popedom.pid"/>" onClick='goSelect(this.id)' checked="checked" >
															</s:if>
															<s:else>
																<input type="checkbox"  name="selectoper" id="<s:property value="#popedom.mid"/>_<s:property value="#popedom.mid"/>" value="<s:property value="#popedom.mid"/>_<s:property value="#popedom.pid"/>" onClick='goSelect(this.id)' >
															</s:else>
													...
													<s:else>
														...
														<div>
														<s:if test="#popedom.flag==1">
															<input type="checkbox"  name="selectoper" id="<s:property value="#popedom.pid"/>_<s:property value="#popedom.mid"/>" value="<s:property value="#popedom.mid"/>_<s:property value="#popedom.pid"/>" onClick='goSelect(this.id)' checked="checked" >
														</s:if>
														<s:else>
															<input type="checkbox"  name="selectoper" id="<s:property value="#popedom.pid"/>_<s:property value="#popedom.mid"/>" value="<s:property value="#popedom.mid"/>_<s:property value="#popedom.pid"/>" onClick='goSelect(this.id)' >
														</s:else>
														<s:property value="#popedom.name"/>
														</div>
  ...
  <tr>
   ...
   <fieldset style="width:100%; border : 1px solid #73C8F9;text-align:left;COLOR:#023726;FONT-SIZE: 12px;"><legend align="left"><a href="#" onclick="displayuser()">用户分配&nbsp;&nbsp;关闭</a></legend>
