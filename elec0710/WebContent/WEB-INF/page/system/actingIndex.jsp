...
<script language="javascript" src="${pageContext.request.contextPath }/ckfinder/ckfinder.js"></script>
  ...
  var len = 500 ;
	...
	function loading(){
	    ...
	    document.getElementById("opperate1").style.display="none";//进度条执行的时候要关//闭的table，自己配置，给页面中的table手动加上id 
	    document.getElementById("opperate2").style.display="none";//进度条执行的时候要关//闭的table，自己配置，给页面中的table手动加上id 
	    openContenFrame();
	}
	*/
  	/*********添加有百分比的进度条显示的js**********/
...
<form name="Form1" id="Form1" method="post">
    ...
    <table id="opperate1" cellPadding="1" cellpadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
		<TBODY>
