...
<HTML>
	...
	<body >
			...
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					...
					<td class="ta_01" colspan="3">
						<s:date name="onDutyDateBegin" format="yy-MM-dd" var="begin"/>
						<s:textfield name="onDutyDateBegin" id="onDutyDateBegin" var="%{begin}" maxlength="50" size="20" onclick="WdatePicker()"></s:textfield>
						~
						<s:date name="onDutyDateEnd" format="yy-MM-dd" var="end"/>
						<s:textfield name="onDutyDateEnd" id="onDutyDateEnd" var="%{#end}" maxlength="50" size="20" onclick="WdatePicker()"></s:textfield>
					</td>
				</tr>
		...
		<form id="Form2" name="Form2" action="${pageContext.request.contextPath }/system/elecUserAction_main.do" method="post">
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<TR height=10><td></td></TR>			
				<tr>
							...
							<s:if test="#request.userList!=null && #request.userList.size()>0">
								<s:iterator value="#request.userList" var="user">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="15%">
											<s:date name="#user.onDutyDate" format="yyy-MM-dd"/>
										</td>								
