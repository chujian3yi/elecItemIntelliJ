...
<html>
 ...
 <body>
    ...
    <table cellSpacing="1" cellPadding="5" width="680" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
	 ...
	 <tr>
		<td class="ta_01" align="center" colSpan="4" background="${pageContext.request.contextPath }/images/b-info.gif">
		 <font face="宋体" size="2">
		 <strong><s:if test="viewflag==null">
			用户管理
		 </s:if>
		 <s:else>
		  	查看用户明细
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.isDutyList" id="isDuty" name="isDuty"
					  listKey="ddlCode" listValue="ddlName"
					  cssStyle="width:155px">
			</s:select>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			<s:textfield name="onDutyDate" id="onDutyDate" value="%{date2}" maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
			<font color="#FF0000">*</font>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：</td>
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="offDutyDate" format="yyyy-MM-dd" var="date3"/>
			<s:textfield name="offDutyDate" id="offDutyDate" value="%{date3}" maxlength="50" size="20" onClick="WdatePicker()" onblur="checkIsDuty(this)"></s:textfield>
		</td>
	</tr>
	<TR>
