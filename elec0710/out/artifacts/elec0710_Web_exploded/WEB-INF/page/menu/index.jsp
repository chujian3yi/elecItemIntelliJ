						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								...
								<tr>
									...
									<td><input type="password" name="password" style="width: 125 px" size="20" value="${requestScope.name }"  maxlength="25"></td>
								...
								<tr>
									...
									<td>
										<table>
											<tr>
												<td>
													<input type="text" name="checkNumber" id="checkNumber" value="${requestScope.password }"  maxlength="4" size="7">
												</td>
												<td>
